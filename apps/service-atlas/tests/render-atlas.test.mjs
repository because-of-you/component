...
test("exposes interactive landmarks through the root SVG accessibility role", () => {
  ...
  assert.match(
    markup,
    /^<svg class="atlas-overlay" viewBox="0 0 160 100" preserveAspectRatio="xMidYMid slice" role="group" aria-label="Interactive service dependency map">/,
  );
...
test("degrades unsafe service links to static landmarks", (t) => {
  ...
  assert.match(
    markup,
    /<g class="landmark landmark--static" data-service-id="traefik" tabindex="0" role="button"/,
  );
